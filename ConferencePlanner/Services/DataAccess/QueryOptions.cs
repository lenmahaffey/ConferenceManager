...
namespace ConferenceManager.Services.DataAccess
{
    public class QueryOptions<T>
    {
        ...
        //public write-only propety for Include strings - converts comma-separated string into array
    ...
    //basically an alias for a list of where expressions - to make code cleaner
